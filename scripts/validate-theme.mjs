...
assert.match(app, /leonetlab:intro:1\.2\.2/)
assert.match(app, /appShellMounted/)
assert.match(app, /@after-leave="handleIntroAfterLeave"/)
assert.match(app, /:duration="\{ enter: 0, leave: INTRO_HANDOFF_DURATION_MS \}"/)
assert.match(app, /prepareHandoff/)
...
assert.match(loadingCover, /motion="static"/)
...
assert.match(nodeGeneralCards, /aria-label="查看财务汇率详情"/)
...
assert.match(serviceWorker, /leonetlab-observatory-v1\.2\.2/)
